      ...
      <main className="landing-main">
        ...
        <section className="landing-hero">
          <div className="landing-hero__content">
            <div className="landing-hero__badge">
              <Zap size={14} />
              <span>The smarter way to manage freelance work</span>
            </div>
            ...
            <p className="landing-hero__subtitle">
              ClientKhata helps you manage client work from pending to paid.
              Stop chasing invoices and start focusing on the work that matters.
            </p>
            ...
            <div className="landing-hero__actions">
              {!user ? (
                <Link
                  to="/login"
                  className="btn btn-primary btn-lg landing-hero__cta"
                >
        ...
        <section id="features" className="landing-bento">
          <div className="landing-section-header">
            <h2 className="landing-section-title">
              Everything you need below one roof
            </h2>
            <p className="landing-section-subtitle">
              A powerful, lightweight suite designed to keep your freelance work
              organized and payments securely tracked.
            </p>
          </div>
          ...
          <div className="bento-grid">
            <div className="bento-card card-large">
              ...
              <p className="bento-desc">
                Keep all your client details, history, and notes in one easily
                searchable place. No more digging through emails to find a phone
                number.
              </p>
            </div>
            ...
            <div className="bento-card">
              ...
              <p className="bento-desc">
                Move every job through simple statuses: Pending, Ongoing, and
                Delivered.
              </p>
            </div>
            ...
            <div className="bento-card">
              ...
              <p className="bento-desc">
                Record partial or full payments per job. Complete multi-currency
                support built in.
              </p>
            </div>
            ...
            <div className="bento-card card-large gradient-card">
              ...
              <p className="bento-desc">
                Get a bird's eye view of your entire business. See pending
                payments, active jobs, and recent client activity the moment you
                log in.
              </p>
            </div>
          </div>
        ...
        <section id="how-it-works" className="landing-how">
          <div className="landing-section-header">
            ...
            <p className="landing-section-subtitle">
              Three straightforward steps to streamline your workflow.
            </p>
          </div>
          ...
          <div className="how-steps">
            <div className="how-step">
              ...
              <p className="step-desc">
                Enter their contact info and details to keep your digital
                rolodex organized and accessible anywhere.
              </p>
            </div>
            <div className="how-step line">
              ...
              <p className="step-desc">
                Define the deliverables, set the price, select the currency, and
                track the status as you work.
              </p>
            </div>
            <div className="how-step line">
              ...
              <p className="step-desc">
                Log your payments directly into the system and quickly generate
                invoices to finalize the project.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="landing-cta">
          <div className="cta-content">
            ...
            <p className="cta-subtitle">
              Join freelancers everywhere who use ClientKhata to stay organized,
              manage projects, and get paid.
            </p>
